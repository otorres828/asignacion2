                    ...
                    <div class="card-body">
                        <form action="../logica/cliente_guardar.php" method="POST" enctype="multipart/form-data">                                                       
                            <div class="form-group">
                                <label >Rif</label>
                                <input type="number"  name="RIFCliente" class="form-control" required >
                            </div>
                            <div class="form-group">
                                <label >Cedula</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  name="TelefonoC" class="form-control" required >  
                            </div>
                            <div class="form-group">
                                <label >Fecha de Afiliacion</label>
                                <input type="date"  name="FechaAfiliacion" class="form-control" required >  
                            </div>
                            <!-- <div class="form-group">
                                <label >Estatus</label>
                                <select  name="StatusC" class="form-control" required > 
                            ...
                            <button name="nuevocliente" type="submit" class="btn btn-success" required>Nuevo</button>
